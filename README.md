...
State...the data frontier. This is the repository of the :star:'ed lib ReduRx. It's continuing mission, to transform state functionally. To store and publish values. To boldly go where...well you get the idea.

![Captain Kirk: KHAAAAANNNNN](http://i.giphy.com/4FheP99tYTXVu.gif)
